package com.example.ckj.viewflipperdemo;
...
public class MainActivity extends AppCompatActivity implements GestureDetector.OnGestureListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < images.length ; i++){
            ...
            viewFlipper.addView(imageView,i,new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,ViewGroup.LayoutParams.MATCH_PARENT));
        }
    ...
    public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
        if(e2.getX() - e1.getX() >FLING_MIN_DISTANCE && Math.abs(velocityX) > FLING_MIN_VELOCITY){
            ...
            viewFlipper.setInAnimation(rOutAnim);
            ...
            viewFlipper.setInAnimation(lOutAnim);
            viewFlipper.showPrevious();
            setTitle("相片编号："+viewFlipper.getDisplayedChild());
            return true;
        }
